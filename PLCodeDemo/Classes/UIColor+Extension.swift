...
extension UIColor {
     ...
     * 通过颜色生成图片
     */
    public func jkMakeImage() -> UIImage {
...
extension CAGradientLayer {
     ...
     */
    public func jkMakeLayer(colors: [UIColor], direction: CAGradientDirection = .horizontal, locations: [NSNumber] = []) {
